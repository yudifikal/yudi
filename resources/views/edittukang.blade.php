      ...
      <form action='{{ url('jasatukang/' . $data->id_tukang) }}' method='post' enctype="multipart/form-data">
        ...
        <div class="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ $data->nama_tukang }}" name='nama_tukang'
                id="nama_tukang">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ $data->harga_tukang }}" name='harga_tukang'
                id="harga_tukang">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="file" class="form-control" name='foto_tukang' id="foto_tukang">
            </div>
          </div>
          <div class="mb-3 row">
