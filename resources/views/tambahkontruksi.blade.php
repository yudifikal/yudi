...
<body class="vh-100">
  <div class="d-flex h-100">
    ...
    <main class="container">
      ...
      @endif
      <form action='{{ url('jasakontruksi') }}' method='post' enctype="multipart/form-data">
        @csrf
        <div class="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ old('nama_kontruksi') }}" name='nama_kontruksi'
                id="nama_kontruksi">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ old('harga_kontruksi') }}" name='harga_kontruksi'
                id="harga_kontruksi">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="file" class="form-control" name='foto_kontruksi' id="foto_kontruksi" accept="image/*">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="jurusan" class="col-sm-2 col-form-label">Keterangan</label>
            <div class="col-sm-10">
              <textarea class="form-control textarea-keterangan" name="keterangan_kontruksi" id="keterangan_kontruksi">{{ old('keterangan_kontruksi') }}</textarea>
            </div>
          </div>
          <div class="mb-3 row">
