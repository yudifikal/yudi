...
<body class="vh-100">
  <div class="d-flex h-100">
    ...
    <main class="container">
      ...
      @endif
      <form action='{{ url('material/' . $data->id_material) }}' method='post' enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="my-3 p-3 bg-body rounded shadow-sm">
          ...
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ $data->nama_material }}" name='nama_material'
                id="nama_material">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ $data->harga_material }}" name='harga_material'
                id="harga_material">
            </div>
          </div>
          <div class="mb-3 row">
            ...
            <div class="col-sm-10">
              <input type="file" class="form-control" name='foto_material' id="foto_material">
            </div>
          </div>
          <div class="mb-3 row">
            <label for="jurusan" class="col-sm-2 col-form-label">Keterangan</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" value="{{ $data->keterangan_material }}"
                name='keterangan_material' id="keterangan_kontruksi">
            </div>
          </div>
          <div class="mb-3 row">
