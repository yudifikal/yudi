...
class JasaKontruksiController extends Controller
{
    public function index()
    {
        $data = JasaKontruksi::orderBy('id', 'desc')->paginate(15);
        return view('jasakontruksi', compact('data'));
    }

    public function create()
    {
        return view('jasakontruksi.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jasakontruksi.index')->with('success', 'Data berhasil ditambahkan');
    }

    public function show($id)
    {
        $data = JasaKontruksi::findOrFail($id);
        return view('jasakontruksi.show', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('jasakontruksi.index')->with('success', 'Data berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('jasakontruksi.index')->with('success', 'Data berhasil dihapus');
    }
}
