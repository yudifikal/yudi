...
class MkController extends Controller
{
    ...
    {
        $data = Material::orderBy('id', 'desc')->get(); // Menggunakan get() untuk mengambil koleksi
        return view('materialkonsumen', compact('data'));
    }

    public function create()
    {
        return view('materialkonsumen.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('materialkonsumen.index')->with('success', 'Data berhasil ditambahkan');
    }

    public function show($id)
    {
        $data = Material::findOrFail($id);
        return view('materialkonsumen.show', compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('materialkonsumen.index')->with('success', 'Data berhasil diperbarui');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('materialkonsumen.index')->with('success', 'Data berhasil dihapus');
    }
}
