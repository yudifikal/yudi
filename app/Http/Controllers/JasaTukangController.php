...
class JasaTukangController extends Controller
{
    public function index()
    {
        $data = JasaTukang::orderBy('id', 'desc')->paginate(15);
        return view('jasatukang', compact('data'));
    }

    public function create()
    {
        return view('jasatukang.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('jasatukang.index')->with('success', 'Data berhasil ditambahkan');
    }

    public function show($id)
    {
        $data = JasaTukang::findOrFail($id);
        return view('jasatukang.show', compact('data'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('jasatukang.index')->with('success', 'Data berhasil dihapus');
    }
}
